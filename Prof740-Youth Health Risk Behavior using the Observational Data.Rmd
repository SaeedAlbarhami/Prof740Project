...
```{r setup, echo=FALSE,fig.cap="", out.width = '100%'}
knitr::include_graphics("logo.png", auto_pdf = getOption("knitr.graphics.auto_pdf", FALSE), dpi = NULL)
knitr::opts_chunk$set(warning=FALSE, message=FALSE)
```

```{r load libraries, echo=FALSE, message=FALSE, warning=FALSE,  fig.width=10,fig.height=11}
...
- CRISP-DM was conceived in 1996 and immature data mining market as a standrized process for data mining projects, The methodolgy provides an overview of the life cycle of a data mining project, In six major steps; Bussniess understanding, Data understanding, Data preparation, Modeling, And Evaluation.


Note: 


- **As per the course requirment deployment step is not included in  **

According to latest poll by https://www.kdnuggets.com/ about which 
...
- Are there relations between victimization (fighting, bullying, sexual abuse) and suicideattempt?


- Are there relations between substance use (Tabaco, alcohol and other substance use) and suicide attempt?

This case study is from the Youth Risk Behavior Survey (YRBS) data which arefree for use.
...
## Loading, Retrieving, Viewing & Inspecting Data 
**Load data**    
```{r  }
...
corrplot(cor(dataCleaned, method = "spearman")
         ...
         tl.col="black", tl.srt=90,sig.level = 0.01, insig = "blank")
