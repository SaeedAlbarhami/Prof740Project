...
Data mining is an innovative and potentially powerful business strategy. A great deal of work involves the analysis of large amounts of information in an attempt to discover underlying patterns in a large amount of data. The process is called data mining because data mining is a process that "mining" data to search for patterns. Such techniques can not only find hidden patterns but identify patterns that would be hard to find through traditional data mining methods.
...
This section invistigate the victimizations variables in dataset, which are ranged in ("qn16","qn17","qn19","qn20","qn21","qn24","qn25"), visulizing thoses variables gave us the following insights.
...
This section invistigates the substance use variables in dataset, which are ranges in ("qn33","qn37","qn43","qn45","qn47","qn50","qn51",qn52","qn53","qn54","qn55","qn56","qn57"), visualizing thoses variables gave us the following insights.
...
This section invistigates the substance use variables in dataset, which are ranges in ("qn27","qn28","qn29","qn30"),visualizing thoses variables gave us the following insights.
...
We check the number of missing values in each field using the following function that generates the following insights.
...
```{r natable,  fig.width=10,fig.height=11}
