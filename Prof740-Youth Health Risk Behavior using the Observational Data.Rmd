---
title: "YOUTH HEALTH RISK BEHAVIOR ANALYSIS"
author: "GROUP 5"
...
<!-- Submit a report:   -->
<!-- 1- Brief introduction about the Use case -->
<!--   - Background -->
<!--   - Current challenges -->
...
head(variableDescription, n=nrow(variableDescription))
...
# str(data)
library(pander)
pander(head(data), table.split.table = inf)
```
...
* Age(1= <=12 years old, 2=13 years old, 3=14 years old, 4=15 years old, 5=16 years old,
6=17 years old, 7=18+ years old)     
* Sex(1=Female, 2=Male)    
...
# testing new package
# library(esquisse)
# esquisse::esquisser(dataCleaned)
#  library(ggplot2)
```
